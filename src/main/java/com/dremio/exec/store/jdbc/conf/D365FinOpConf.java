...
@SourceType(value = "D365FinOpARP", label = "D365FinOp",uiConfig = "d365finop-layout.json")
public class D365FinOpConf extends AbstractArpConf<D365FinOpConf> {
  private static final String ARP_FILENAME = "arp/implementation/d365finop-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.d365finop.D365FinOpDriver";
